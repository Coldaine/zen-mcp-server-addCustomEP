...
class ModelProviderRegistry:
    ...
    PROVIDER_PRIORITY_ORDER = [
        ...
        ProviderType.Z_AI,  # Direct Z.AI GLM access
        ProviderType.MOONSHOT,  # Direct Moonshot Kimi access
        ProviderType.QWEN,  # Direct Qwen access
        ProviderType.DIAL,  # DIAL unified API access
        ProviderType.KILO,  # Kilo Code API (OpenRouter substitute)
    ...
    def _get_api_key_for_provider(cls, provider_type: ProviderType) -> Optional[str]:
        ...
        key_mapping = {
            ...
            ProviderType.KILO: "KILO_API_KEY",
            ProviderType.MOONSHOT: "MOONSHOT_API_KEY",
            ProviderType.Z_AI: "Z_AI_API_KEY",
